...
class MiatestDeliver(models.Model):
    deliverno = models.CharField(max_length=20)

    class Meta:
        managed = False
        db_table = 'miatest_deliver'


class MiatestInfor(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'miatest_infor'


class MiatestOrder(models.Model):
